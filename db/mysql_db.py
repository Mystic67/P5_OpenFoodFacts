...
class Mysql_db:
    '''This class connect user to database, create the database and the tables and put the OpenFoodFacts data into the tables'''
    def __init__(self):
    ...
    def create_database(self):
        try:
            ...
            print(display_constants.colours["black"],\
                display_constants.colours["on_yellow"],\
                display_constants.colours["blink"],\
                "Création de la base de données {}. Veuillez patienter !".format(db_constants.DB_NAME),\
            ...
            if err.errno == 1044:
                ...
                print("Création de la base de données {}".format(db_constants.DB_NAME))
