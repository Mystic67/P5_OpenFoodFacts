...
fr_food_informations = { "Non du produit" : "product_name", "Nom générique" : "generic_name",\
     "Marques" : "brands", "Catégories" : "categories", "Note nutritionnelle (A à E)" : "nutrition_grades",\
     "Groupe Nova (1 à 4)" : "nova_groups", "Allergènes" : "allergens", 
          "Lien Open Food Facts" : "url" }